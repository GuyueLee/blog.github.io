...
{% include base_path %}
## 2024
- Y. Du, H. Dai, H. Liu, **G. Li**, Y. Ren and K. Zhang, "Efficient and Error-Free Secret Key Generation Leveraging Sorted Indices Matching," in IEEE Transactions on Mobile Computing, doi: 10.1109/TMC.2024.3465042.keywords: {Quantization (signal);Pattern matching;Noise;Accuracy;Wireless communication;Perturbation methods;Sorting;Error-free key generation;noise perturbation;sorted indices matching},
